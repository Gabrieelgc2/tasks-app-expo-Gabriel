...
const s = StyleSheet.create({
  safe: { flex: 1, backgroundColor: '#0000ff' },
  glowBg: {
    position: 'absolute', top: -80, left: '50%', marginLeft: -180,
    width: 360, height: 360, borderRadius: 180,
    backgroundColor: 'rgba(0, 255, 221, 0.06)',
  },
  scanLine: {
    position: 'absolute', left: 0, right: 0, height: 2,
    backgroundColor: 'rgba(178, 254, 0, 0.12)',
    zIndex: 999,
  },
  container: {
  ...
  logoIcon: {
    fontSize: 36, color: '#5d00ff',
    textShadowColor: '#dac4ff', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 20,
    marginBottom: 8,
  },
  title: {
    fontSize: 26, fontWeight: '900', color: '#59ff00', letterSpacing: 10,
    textShadowColor: '#ff0000', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 12,
  },
  subtitle: { color: '#00a6ff', fontSize: 10, letterSpacing: 3, marginTop: 4 },
  card: {
    backgroundColor: '#ff9900', borderRadius: 14,
    borderWidth: 1, borderColor: '#00009a', padding: 20,
    shadowColor: '#7c3aed', shadowOffset: { width: 0, height: 0 },
    shadowOpacity: 0.15, shadowRadius: 20, elevation: 8,
  },
  cardTitle: { color: '#ff00ea', fontSize: 10, fontWeight: '700', letterSpacing: 4, marginBottom: 16 },
  fieldGroup: { marginBottom: 12 },
  label: { color: '#ff00d0', fontSize: 9, fontWeight: '700', letterSpacing: 3, marginBottom: 5 },
  input: {
  ...
  inputFlex: { flex: 1 },
  inputActive: { borderColor: '#00f7ff' },
  inputError:  { borderColor: '#f7002d' },
  inputMatch:  { borderColor: '#ffa200' },
  confirmRow: { flexDirection: 'row', alignItems: 'center', gap: 2},
